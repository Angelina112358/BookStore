...
namespace Store.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IPaymentService, Contractor.YandexKassa.YandexKassaPaymentService>();
            services.AddSingleton<IWebContractorService, Contractor.YandexKassa.YandexKassaPaymentService>();

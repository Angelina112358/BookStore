...
namespace Store.Web.App
{
    public class OrderService
    {
        ...
        protected ISession Session => httpContextAccessor.HttpContext.Session; //текущая сессия
        ...
        public OrderModel SendConfirmation(string cellPhone)
        {
            ...
            if (TryFormatPhone(cellPhone, out string formattedPhone))
            {
                ...
                model.Errors["cellPhone"] = "Номер телефона не соответствует формату +375257794318";
